...
/**
 * WARNING: THIS FILE IS UNDER PUPPET CONTROL. LOCAL CHANGES WILL BE OVERWRITTEN.
 */

// jchristi: Drush uses a ton of memory so increase the limit here instead of in php.ini
...
#$options['l'] = 'http://rhc4tp-build.devlab.redhat.com';

// Specify your Drupal core base directory (useful if you use symlinks).
$options['r'] = '/var/www/public_html';
 ...
 */
$options['drush_usage_log'] = FALSE;
$options['drush_usage_send'] = FALSE;
 ...
 */
$options['include'] = '/usr/share/drush/commands';
